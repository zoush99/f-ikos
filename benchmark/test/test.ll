; ModuleID = '/tmp/test-300372.ll'
source_filename = "/tmp/test-300372.ll"
...
!2 = distinct !DICompileUnit(language: DW_LANG_Fortran90, file: !3, producer: " F90 Flang - 1.5 2017-05-01", isOptimized: false, flags: "'+flang -emit-llvm -S -c test/test.f90 -o test/test.ll'", runtimeVersion: 0, emissionKind: FullDebug, enums: !4, retainedTypes: !4, globals: !4, imports: !4, nameTableKind: None)
!3 = !DIFile(filename: "test/test.f90", directory: "/home/zou/Documents/f-ikos/benchmark")
!4 = !{}
